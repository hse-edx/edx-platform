...
installation from the ``/api/courses/v1/courses/`` REST endpoint.
...
.. note::
    ...
    The developer documentation available at `edX platform documentation`_ does
    not include information about the ``/api/courses/v1/courses/`` REST
    endpoint. Developer documentation for the ``/api/courses/v1/courses/`` is
    planned in upcoming documentation releases.
