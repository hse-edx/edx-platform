...
(function (globals) {
  ...
  django.catalog = {
    ...
    "Additional Information (optional)": "Information compl\u00e9mentaire (optionnel)", 
    ...
    "Basic Account Information (required)": "Informations g\u00e9n\u00e9rales du compte (obligatoire)", 
    ...
    "Connect your {accountName} account": "Connectez votre compte {accountName}", 
    ...
    "Please enter a term in the %(anchor_start)s search field%(anchor_end)s.": "Saisir votre terme dans le %(anchor_start)s champ de recherche%(anchor_end)s.", 
    ...
    "Showing %(first_index)s out of %(num_items)s total": "%(first_index)s sur %(num_items)s au total", 
    ...
    "The topic \"%(topic)s\" could not be found.": "Sujet \"%(topic)s\" non trouv\u00e9.", 
    ...
    "There are invalid keywords in your email. Please check the following keywords and try again:": "Votre courriel contient des mots-cl\u00e9s invalides. Veuillez consulter la liste de mots-cl\u00e9s ci-dessous et essayer de nouveau:", 
    ...
    "When you click \"Reset Password\", a message will be sent to your email address. Click the link in the message to reset your password.": "En cliquant sur \"R\u00e9initialiser votre mot de passe\", un message vous sera envoy\u00e9 \u00e0 votre adresse email. Cliquez sur le lien dans le message pour r\u00e9initialiser votre mot de passe.", 
    "Whole words": "Mots entiers", 
    "Width": "Largeur", 
    "Words: {0}": "Mots : {0}", 
    "Year of Birth": "Ann\u00e9e de naissance", 
    "Yes, delete this %(xblock_type)s": "Oui, supprimer ce %(xblock_type)s", 
    "You are about to send an email titled '<%= subject %>' to ALL (everyone who is enrolled in this course as student, staff, or instructor). Is this OK?": "Vous \u00eates sur le point d'envoyer un e-mail intitul\u00e9 '<%= subject %>' \u00e0 TOUS (n'importe quelle personne inscrite au cours en tant qu'\u00e9tudiant, professeur ou membre du staff). Voulez-vous continuer ? ", 
    ...
    "Your email was successfully queued for sending.": "Votre e-mail est en attente d\u2019envoi.", 
